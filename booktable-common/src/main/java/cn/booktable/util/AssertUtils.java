...
public class AssertUtils  {
     ...
     * @param message
     */
    public static void isNotBlank(String param, String message) {
        if (StringUtils.isEmpty(param)) {
            throw new BusinessException(BusinessException.code_assert,message);
        }
    }
    ...
    public static void notNull(Object object, String message) {
        notNull(object,BusinessException.code_assert,message);
    }
    ...
    public static void isInstanceOf(Class<?> type, Object obj, String message) {
        ...
        if (!type.isInstance(obj)) {
            throw new BusinessException(BusinessException.code_assert,
    ...
    public static void isAssignable(Class<?> superType, Class<?> subType, String message) {
        ...
        if (subType == null || !superType.isAssignableFrom(subType)) {
            throw new BusinessException(BusinessException.code_assert,message + subType + " is not assignable to " + superType);
        }
    }
    ...
    /**
     * Assert a boolean expression, throwing {@link BusinessException}
     * if the test result is {@code false}.
